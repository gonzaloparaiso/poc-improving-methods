...
ins('im_suscripciones_catalogo', 0, 'cat1', { id: 'cat1', nombre: 'Plan Test', tipo: 'recurrente', precioMensual: 30, primerMesPrueba: false, programas: [{ programaId: 'p1', fechaInicio: lunesISO }], creadoEn: '2024-01-01T00:00:00.000Z' })
