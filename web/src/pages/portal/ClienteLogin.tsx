    ...
    <div className="min-h-screen bg-tn-black flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-tn-yellow rounded-2xl mb-4 shadow-lg shadow-tn-yellow/20">
            <svg className="w-9 h-9 text-tn-black" fill="currentColor" viewBox="0 0 24 24">
